...
adj = gridnetwork(5, 5)
types = Dict(1 => collect(1:2:25), 2 => collect(2:2:25))
φ = s_t_connectivity([1:25;], [1], [25])

# Load exact solution
@load "demo/data/grid_55_exact.jld2"

## Percolation error
signature_percolation = percolation_preprocessor(signature_55_exact, adj)

absolute_error_percolation = norm(signature_55_exact .- signature_percolation)
relative_error_percolation = absolute_error_percolation / norm(signature_55_exact)
...
P_exact = reliability(t, signature_55_exact, dists)
